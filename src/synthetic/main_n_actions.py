...
def main(cfg: DictConfig) -> None:
    ...
    # log path
    log_path = Path("./varying_n_actions")
    df_path = log_path / "df"
    ...
    elapsed_prev = 0.0
    result_df_list = []
    for n_actions in cfg.setting.n_actions_list:
        ...
        dataset = SyntheticBanditDataset(
            ...
            n_deficient_actions=int(n_actions * cfg.setting.n_def_actions),
        ...
        logger.info(f"n_actions={n_actions}: {elapsed}min (diff {diff}min)")
