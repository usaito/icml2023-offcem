...
def main(cfg: DictConfig) -> None:
    ...
    # log path
    log_path = Path("./varying_n_clusters")
    df_path = log_path / "df"
    ...
    elapsed_prev = 0.0
    result_df_list = []
    for n_clusters in cfg.setting.n_clusters_list:
        ...
        result_df["n_clusters"] = n_clusters
        ...
        logger.info(f"n_clusters={n_clusters}: {elapsed}min (diff {diff}min)")
